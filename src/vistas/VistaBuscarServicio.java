...
public class VistaBuscarServicio extends javax.swing.JFrame implements Views<Servicio> {
    ...
    private void initComponents() {
        ...
        lblBuscar.setText("BUSCAR SERVICIO");
        ...
        lblSeleccione.setText("Seleccione un servicio de la lista.");
        ...
        lblCódigo.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        lblCódigo.setForeground(new java.awt.Color(42, 99, 153));
    ...
    if (servicios == null) {
        showError("No hay servicios registrados");
        return;
    }
    ...
    boolean coincideCodigo =codigo.isEmpty() || String.valueOf(servicio.getCodigo()).contains(codigo);
    boolean coincideNombre = nombre.isEmpty() || servicio.getNombre().toLowerCase().contains(nombre.toLowerCase());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VistaBuscarServicio().setVisible(true));
